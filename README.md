...
Data:
- Raw FASTQ files can be obtained from the ENA repository under the study number PRJEB81816
...
Data: 
- Raw (fastqs and bigwigs) and processed data (merged peak files) can be obtained from the ENA repository under the study number PRJEB107008
- Merged peak files can also be obtained within this repository under ChIP-seq/processed_data
