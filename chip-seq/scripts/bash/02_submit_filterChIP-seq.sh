...
REPLICATE_ID=`head -n $SGE_TASK_ID $IDS | tail -n 1`
...
REP=${REPLICATE_ID}.sorted.bam
UNIQUE_REP=${REPLICATE_ID}.unique.sorted.bam
SORTED_UNIQUE_REP=${REPLICATE_ID}.sorted.unique.sorted.bam
FIXMATE_REP=${REPLICATE_ID}.fixmate.sorted.unique.sorted.bam
POSITION_FIXMATE_REP=${REPLICATE_ID}.position.fixmate.sorted.unique.sorted.bam
MARKDUP_REP=${REPLICATE_ID}.markdup.position.fixmate.sorted.unique.sorted.bam
FILTERED_REP=${REPLICATE_ID}.filtered.markdup.position.fixmate.sorted.unique.sorted.bam
FINAL_REP=${REPLICATE_ID}.final.bam
